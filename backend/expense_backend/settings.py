...
SECURE_SSL_REDIRECT = False  # Set to True if using HTTPS (requires reverse proxy like nginx)
SESSION_COOKIE_SECURE = False  # Set to True if using HTTPS
CSRF_COOKIE_SECURE = False  # Set to True if using HTTPS
SECURE_PROXY_SSL_HEADER = None  # Set to ('HTTP_X_FORWARDED_PROTO', 'https') if behind reverse proxy
